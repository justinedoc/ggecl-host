...
import SignupDetailsForm from "../_components/InstructorSignupDetailsForm";
import SignupForm from "../_components/InstructorSignupForm";
    ...
    <AuthContainer isPending={isPending}>
      {step > 1 && (
        <button
          ...
          className="absolute top-3 left-8 flex cursor-pointer items-center gap-1 rounded-md border bg-gray-100 p-2 text-xs md:left-[37%] dark:bg-gray-800"
        >
          <ArrowLeft />
        </button>
      )}
